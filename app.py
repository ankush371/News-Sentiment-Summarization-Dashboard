...
# Suppress HuggingFace FutureWarning about resume_download
import warnings
...
<style>
    ...
    html, body, [data-testid="stAppViewContainer"], [data-testid="stApp"] {
        background-color: #070b14 !important; color: #c8d8e8 !important;
    }
    [data-testid="stMain"], .main, .block-container {
        background-color: #070b14 !important; padding-top: 1.8rem !important;
        font-family: 'Exo 2', sans-serif !important;
    }
    [data-testid="stSidebar"] { background: #0b1120 !important; border-right: 1px solid #0ff2 !important; }
    [data-testid="stSidebar"] * { color: #a0c4d8 !important; font-family: 'Exo 2', sans-serif !important; }
    [data-testid="stSidebar"] .stButton > button {
        background: transparent !important; border: 1px solid #0ff4 !important;
        color: #00e5ff !important; font-family: 'Share Tech Mono', monospace !important;
        font-size: 0.78rem !important; letter-spacing: 0.05em !important; transition: all 0.2s !important;
    }
    [data-testid="stSidebar"] .stButton > button:hover {
        background: #00e5ff18 !important; border-color: #00e5ff !important; box-shadow: 0 0 12px #00e5ff44 !important;
    }
    [data-testid="stSidebar"] .stButton > button[kind="primary"], button[kind="primary"] {
        background: linear-gradient(135deg, #00b4d8, #00e5ff) !important; border: none !important;
        color: #070b14 !important; font-weight: 700 !important; font-family: 'Exo 2', sans-serif !important;
        letter-spacing: 0.08em !important; box-shadow: 0 0 20px #00e5ff55 !important; transition: all 0.3s !important;
    }
    button[kind="primary"]:hover { box-shadow: 0 0 35px #00e5ff88 !important; transform: translateY(-1px) !important; }
    [data-testid="stTextInput"] input {
        background: #0f1a2e !important; border: 1px solid #0ff3 !important;
        color: #00e5ff !important; font-family: 'Share Tech Mono', monospace !important; border-radius: 4px !important;
    }
    [data-testid="stTextInput"] input:focus { border-color: #00e5ff !important; box-shadow: 0 0 10px #00e5ff33 !important; }
    [data-testid="stSlider"] * { color: #00e5ff !important; }
    [data-testid="metric-container"] {
        background: #0b1627 !important; border: 1px solid #0ff2 !important; border-radius: 8px !important;
        padding: 1rem 1.2rem !important; box-shadow: 0 0 20px #00e5ff0a !important; transition: box-shadow 0.3s !important;
    }
    [data-testid="metric-container"]:hover { box-shadow: 0 0 30px #00e5ff22 !important; border-color: #00e5ff44 !important; }
    [data-testid="stMetricValue"] { font-family: 'Share Tech Mono', monospace !important; color: #00e5ff !important; font-size: 1.8rem !important; }
    [data-testid="stMetricLabel"] { color: #5d8a9e !important; font-size: 0.72rem !important; letter-spacing: 0.12em !important; text-transform: uppercase !important; }
    [data-testid="stTabs"] [role="tablist"] { border-bottom: 1px solid #0ff2 !important; gap: 0 !important; }
    [data-testid="stTabs"] button[role="tab"] {
        background: transparent !important; color: #4a7a8e !important;
        font-family: 'Share Tech Mono', monospace !important; font-size: 0.8rem !important;
        letter-spacing: 0.1em !important; border: none !important; padding: 0.5rem 1.2rem !important; transition: all 0.2s !important;
    }
    [data-testid="stTabs"] button[role="tab"][aria-selected="true"] {
        color: #00e5ff !important; border-bottom: 2px solid #00e5ff !important; text-shadow: 0 0 10px #00e5ff88 !important;
    }
    [data-testid="stExpander"] {
        background: #0b1627 !important; border: 1px solid #0ff2 !important;
        border-radius: 6px !important; margin-bottom: 0.5rem !important; transition: border-color 0.2s !important;
    }
    [data-testid="stExpander"]:hover { border-color: #00e5ff44 !important; }
    [data-testid="stExpander"] summary { color: #c8d8e8 !important; font-family: 'Exo 2', sans-serif !important; font-weight: 600 !important; font-size: 0.93rem !important; }
    [data-testid="stExpander"] summary:hover { color: #00e5ff !important; }
    hr { border-color: #0ff1 !important; }
    [data-testid="stStatus"] { background: #0b1627 !important; border: 1px solid #0ff2 !important; color: #a0c4d8 !important; font-family: 'Share Tech Mono', monospace !important; font-size: 0.85rem !important; }
    [data-testid="stAlert"] { background: #0b1627 !important; border: 1px solid #00e5ff44 !important; color: #a0c4d8 !important; font-family: 'Exo 2', sans-serif !important; }
    ...
    [data-testid="stDownloadButton"] button {
        background: #0b1627 !important; border: 1px solid #00e5ff66 !important;
        color: #00e5ff !important; font-family: 'Share Tech Mono', monospace !important;
        letter-spacing: 0.1em !important; transition: all 0.3s !important;
    }
    [data-testid="stDownloadButton"] button:hover { background: #00e5ff15 !important; box-shadow: 0 0 20px #00e5ff44 !important; }
    ::-webkit-scrollbar { width: 4px; }
    ::-webkit-scrollbar-track { background: #070b14; }
    ::-webkit-scrollbar-thumb { background: #00e5ff44; border-radius: 2px; }
    .main-title { font-family: 'Exo 2', sans-serif !important; font-size: 2.4rem !important; font-weight: 800 !important; letter-spacing: 0.02em !important; color: #ffffff !important; text-shadow: 0 0 30px #00e5ff66 !important; margin-bottom: 0 !important; }
    .subtitle { font-family: 'Share Tech Mono', monospace !important; color: #3a6a7e !important; font-size: 0.82rem !important; letter-spacing: 0.18em !important; text-transform: uppercase !important; margin-top: 0.2rem !important; }
    .summary-box { background: #0b1627; border-left: 3px solid #00e5ff; padding: 1.1rem 1.4rem; border-radius: 0 6px 6px 0; font-family: 'Exo 2', sans-serif; font-size: 0.96rem; line-height: 1.75; color: #c8d8e8; box-shadow: inset 0 0 40px #00e5ff08, 0 0 20px #00000044; }
    .impact-card { background: #0c1828; border-left: 3px solid #00b4d8; padding: 0.75rem 1rem; border-radius: 0 6px 6px 0; margin-bottom: 0.5rem; font-family: 'Share Tech Mono', monospace; font-size: 0.82rem; line-height: 1.65; color: #a0c4d8; transition: border-color 0.2s; }
    .impact-card:hover { border-left-color: #00e5ff; }
    .article-meta { font-family: 'Share Tech Mono', monospace; color: #3a6a7e; font-size: 0.75rem; letter-spacing: 0.06em; margin-bottom: 0.4rem; }
    .badge-pos { background: #00e5ff18; color: #00e5ff; border: 1px solid #00e5ff44; border-radius: 3px; padding: 1px 8px; font-family: 'Share Tech Mono', monospace; font-size: 0.72rem; letter-spacing: 0.05em; }
    .badge-neg { background: #ff3c5218; color: #ff6b8a; border: 1px solid #ff3c5244; border-radius: 3px; padding: 1px 8px; font-family: 'Share Tech Mono', monospace; font-size: 0.72rem; letter-spacing: 0.05em; }
    h2, h3, [data-testid="stSubheader"] { font-family: 'Exo 2', sans-serif !important; color: #c8d8e8 !important; letter-spacing: 0.04em !important; border-bottom: 1px solid #0ff1 !important; padding-bottom: 0.3rem !important; }
    p, li, .stMarkdown { color: #8aaec0 !important; }
    [data-testid="stCaptionContainer"] p { font-family: 'Share Tech Mono', monospace !important; color: #2a5a6e !important; font-size: 0.72rem !important; letter-spacing: 0.08em !important; }
</style>
...
if not GROQ_API_KEY:
    st.warning('GROQ_API_KEY is not set — AI action guidance will be disabled.')
...
def clean_articles(articles: list) -> pd.DataFrame:
    ...
    out['description'] = out['description'].replace('', 'No description available.')
...
def run_sentiment(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # FIX: use a copy — never mutate the cached input DataFrame
    out = df.copy()
...
def run_summarization(df: pd.DataFrame) -> str:
    ...
    # FIX: read device from the already-loaded model — don't call .to(device) again
...
def run_extractive_summary(df: pd.DataFrame) -> str:
    """Fast summary rendered as HTML so it displays correctly inside the summary-box div."""
    top   = df.head(5)
    items = []
    for _, row in top.iterrows():
...
{{
    ...
    "what_it_means": ["exactly 3 concise bullet points"],
    "suggested_actions": ["3 to 4 concrete actions the customer can take in the next 24-72 hours"]
}}
...
def render_articles(df: pd.DataFrame):
    for _, row in df.iterrows():
        if row['sentiment_label'] == 'positive':
            ...
            badge = f'<span class="badge-neg">NEGATIVE {row["sentiment_score"]:.0%}</span>'
        else:
            badge = f'<span style="background:#1a2a3a;color:#3a6a7e;border:1px solid #3a6a7e44;border-radius:3px;padding:1px 8px;font-family:monospace;font-size:0.72rem;">NEUTRAL {row["sentiment_score"]:.0%}</span>'
...
with st.sidebar:
    ...
    analysis_mode = st.selectbox(
        ...
        help='Fast: extractive bullets. Deep: transformer summary + AI guidance.'
    )
    ...
    if st.session_state.history:
        ...
        for i, h in enumerate(reversed(st.session_state.history[-8:])):
            ...
            with col1:
                if st.button(h['topic'], key=f'hist_{i}', use_container_width=True):
    ...
    st.caption('Guidance: Groq LLaMA 3.3 (free)')
...
if run_button:
    ...
    with st.status('Analyzing...', expanded=True) as steps:
        ...
        guidance_data = None
        if GROQ_API_KEY and summary and analysis_mode == 'Deep':
            st.write('🌐 Generating action guidance...')
...
if res:
    ...
    if guidance_data:
        ...
        risk_color = {'low': '#00d084', 'medium': '#f5c542', 'high': '#ff6b6b'}.get(
            guidance_data.get('risk_level', 'medium'), '#f5c542'
        )
        ...
        with right:
            ...
            st.markdown(
                f'<div style="padding:0.5rem 0.8rem;border-left:3px solid {risk_color};'
                f'background:#0c1828;border-radius:0 6px 6px 0;text-transform:uppercase;'
                f'letter-spacing:0.08em;">{guidance_data.get("risk_level","medium")}</div>',
                unsafe_allow_html=True
            )
            st.markdown('')
    ...
    if sentiment_filter == 'Positive only':
        filtered = filtered[filtered['sentiment_label'] == 'positive'].reset_index(drop=True)
    elif sentiment_filter == 'Negative only':
        filtered = filtered[filtered['sentiment_label'] == 'negative'].reset_index(drop=True)
    elif sentiment_filter == 'Neutral only':
        filtered = filtered[filtered['sentiment_label'] == 'neutral'].reset_index(drop=True)
    ...
    filtered['_rank'] = filtered['sentiment_label'].map(sentiment_rank).fillna(1)
    if sort_by == 'Highest confidence':
        filtered = filtered.sort_values('sentiment_score', ascending=False)
    elif sort_by == 'Most positive':
        filtered = filtered.sort_values(['_rank', 'sentiment_score'], ascending=[False, False])
    elif sort_by == 'Most negative':
        filtered = filtered.sort_values(['_rank', 'sentiment_score'], ascending=[True, False])
    else:
        filtered = filtered.sort_values('publishedAt', ascending=False)
    filtered = filtered.drop(columns=['_rank']).reset_index(drop=True)
